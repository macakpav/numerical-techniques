function c = dot_t_t(a,na,b,nb,dim)
   ...
   if nb==1
      ...
      elseif dim == 2
         ...
         for ii=1:na         
            ...
            c(3,ii) = a(1,ii)*b(3) + a(3,ii)*b(4);
            c(4,ii) = a(2,ii)*b(3) + a(4,ii)*b(4);
         end
         return
      else
         c = zeros(els,na);
         for ii=1:na
            ...
            c(4,ii) = a(1,ii)*b(4) + a(4,ii)*b(5) + a(7,ii)*b(6);
            c(5,ii) = a(2,ii)*b(4) + a(5,ii)*b(5) + a(8,ii)*b(6);
            c(6,ii) = a(3,ii)*b(4) + a(6,ii)*b(5) + a(9,ii)*b(6);
            c(7,ii) = a(1,ii)*b(7) + a(4,ii)*b(8) + a(7,ii)*b(9);
            c(8,ii) = a(2,ii)*b(7) + a(5,ii)*b(8) + a(8,ii)*b(9);
            c(9,ii) = a(3,ii)*b(7) + a(6,ii)*b(8) + a(9,ii)*b(9);
         end
         return
      end
   end
   ...
   if na==1
      ...
      elseif dim == 2
         ...
         for ii=1:nb
            ...
            c(3,ii) = a(1)*b(3,ii) + a(3)*b(4,ii);
            c(4,ii) = a(2)*b(3,ii) + a(4)*b(4,ii);
         end
         return
      else
         c = zeros(els,nb);
         for ii=1:nb
            ...
            c(4,ii) = a(1)*b(4,ii) + a(4)*b(5,ii) + a(7)*b(6,ii);
            c(5,ii) = a(2)*b(4,ii) + a(5)*b(5,ii) + a(8)*b(6,ii);
            c(6,ii) = a(3)*b(4,ii) + a(6)*b(5,ii) + a(9)*b(6,ii);
            c(7,ii) = a(1)*b(7,ii) + a(4)*b(8,ii) + a(7)*b(9,ii);
            c(8,ii) = a(2)*b(7,ii) + a(5)*b(8,ii) + a(8)*b(9,ii);
            c(9,ii) = a(3)*b(7,ii) + a(6)*b(8,ii) + a(9)*b(9,ii);
         end
         return
      end
   end
   ...
   if na==nb
      ...
      elseif dim == 2
         ...
         for ii=1:nb         
            ...
            c(3,ii) = a(1,ii)*b(3,ii) + a(3,ii)*b(4,ii);
            c(4,ii) = a(2,ii)*b(3,ii) + a(4,ii)*b(4,ii);
         end
         return
      else
         c = zeros(els,nb);
         for ii=1:nb
            ...
            c(4,ii) = a(1,ii)*b(4,ii) + a(4,ii)*b(5,ii) + a(7,ii)*b(6,ii);
            c(5,ii) = a(2,ii)*b(4,ii) + a(5,ii)*b(5,ii) + a(8,ii)*b(6,ii);
            c(6,ii) = a(3,ii)*b(4,ii) + a(6,ii)*b(5,ii) + a(9,ii)*b(6,ii);
            c(7,ii) = a(1,ii)*b(7,ii) + a(4,ii)*b(8,ii) + a(7,ii)*b(9,ii);
            c(8,ii) = a(2,ii)*b(7,ii) + a(5,ii)*b(8,ii) + a(8,ii)*b(9,ii);
            c(9,ii) = a(3,ii)*b(7,ii) + a(6,ii)*b(8,ii) + a(9,ii)*b(9,ii);
         end
         return
      end
   end
